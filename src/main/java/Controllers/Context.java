...
public class Context {
    private static final HashMap<String, Locale> availableLocales = new HashMap<String, Locale>(){{
        put("ar", new Locale("ar"));
        put("en", new Locale("en"));
    }};

    private static final HashMap<String, String[]> themes = new HashMap<String, String[]>(){{
    ...
    private static final Locale defaultLocale = availableLocales.get("en");

    private Locale currLocale = defaultLocale;

    private static final String[] defaultTheme = themes.get("dark");
